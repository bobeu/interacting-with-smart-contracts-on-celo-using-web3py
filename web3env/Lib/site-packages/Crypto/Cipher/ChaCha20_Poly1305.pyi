...
class ChaCha20Poly1305Cipher:
    ...
    @overload
    def encrypt(
        self, plaintext: ByteString, output: Union[bytearray, memoryview]
    ) -> None: ...
    @overload
    ...
    def decrypt_and_verify(
        self, ciphertext: ByteString, received_mac_tag: ByteString
    ) -> bytes: ...

def new(
    key: ByteString, nonce: Optional[ByteString] = ...
