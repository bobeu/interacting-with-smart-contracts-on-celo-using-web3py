...
class bitarray:
    ...
    def count(
        self, value: int = ..., start: int = ..., stop: int = ..., step: int = ...
    ) -> int: ...
    ...
    def fill(self) -> int: ...
    def find(
        self, a: Union[bitarray, int], start: int = ..., stop: int = ...
    ) -> int: ...
    ...
    def iterdecode(self, code: Union[CodeDict, decodetree]) -> Iterator: ...
    def itersearch(self, a: Union[bitarray, int]) -> Iterator[int]: ...
    def pack(self, b: BytesLike) -> None: ...
    def pop(self, i: int = ...) -> int: ...
    def remove(self, value: int) -> None: ...
    def reverse(self) -> None: ...
    def search(self, a: Union[bitarray, int], limit: int = ...) -> list[int]: ...
